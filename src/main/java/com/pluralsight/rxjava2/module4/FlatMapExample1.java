...
public class FlatMapExample1 {
    ...
    public static void main(String[] args) {
        ...
        Observable<Object> greekLetterPairs = GreekAlphabet.greekAlphabetInGreekObservable()
                ...
                }, /* max concurrency of threads*/3)
                .observeOn(scheduler1) //using custom pool 1
                ;
        ...
        greekLetterPairs
                ...
                }) //when you run the program you will find the events are not in order. they return output in chunks of 3 with any order
