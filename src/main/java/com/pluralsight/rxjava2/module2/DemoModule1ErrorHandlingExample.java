...
public class DemoModule1ErrorHandlingExample {
    ...
    public static void main(String[] args) {
        ...
        zipTogether
        		//*********** Once error occurred at 5th event: observable will return new GreekLetterPair("ÎºÎµÏ�Î±Î¯Î±", "BOOM")
                // onErrorResumeNext
                // The placement of onError operators matter.  It must be downstream of the exceptions
                // they are meant to guard against.
                .onErrorResumeNext(Observable.just(new GreekLetterPair("ÎºÎµÏ�Î±Î¯Î±", "BOOM")))
...
706    [main                      ] [INFO ] [odule1ErrorHandlingExample] - onSubscribe
729    [main                      ] [INFO ] [odule1ErrorHandlingExample] - onNext - (α,alpha)
729    [main                      ] [INFO ] [odule1ErrorHandlingExample] - onNext - (β,beta)
729    [main                      ] [INFO ] [odule1ErrorHandlingExample] - onNext - (γ,gamma)
729    [main                      ] [INFO ] [odule1ErrorHandlingExample] - onNext - (δ,delta)
736    [main                      ] [INFO ] [odule1ErrorHandlingExample] - onNext - (ÎºÎµÏ�Î±Î¯Î±,BOOM)
736    [main                      ] [INFO ] [odule1ErrorHandlingExample] - onComplete
